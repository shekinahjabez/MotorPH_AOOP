...
public class FinanceDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        netPayLabelValue.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        payrollReportButton.setBackground(new java.awt.Color(255, 153, 51));
        payrollReportButton.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        payrollReportButton.setForeground(new java.awt.Color(255, 255, 255));
        payrollReportButton.setText("Generate Payroll Report");
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(allowPayLabel, javax.swing.GroupLayout.Alignment.LEADING))
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel9Layout.createSequentialGroup()
                                        .addComponent(payrollReportButton, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
                                    .addGroup(jPanel9Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(taxPayLabel)
                                .addComponent(taxPayLabelValue))
                            .addComponent(payrollReportButton, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(exportAttendanceButton)
                .addContainerGap())
        );
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addGroup(jPanel10Layout.createSequentialGroup()
                                                    .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        .addComponent(riceTField, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE)
                                                        .addComponent(phoneAllowTField))
                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                    .addComponent(empClothAllowLabel)
                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                    .addComponent(clothingTField, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                ...
                                .addGap(68, 68, 68)
                                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(tinTField, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(sssTField, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel10Layout.createSequentialGroup()
                                        .addComponent(empPhilhealthLabel)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(philhealthTField, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel10Layout.createSequentialGroup()
                                        .addComponent(empPagibigLabel)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(pagibigTField, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void searchButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButton1ActionPerformed
        String empIdInput = searchTextField1.getText().trim();
        empIdInput = empIdInput.equals("Enter the Employee ID here...") ? "" : empIdInput;

        // Validate numeric input
        if (!empIdInput.isEmpty() && !empIdInput.matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "Employee ID must contain numbers only!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
            return;
        }

        employeeSearchID = empIdInput.isEmpty() ? null : Integer.parseInt(empIdInput);
        ...
        updatePayrollEmpLabels(empAccount); // Set name, position, etc.
        ...
        Integer yearValue = selectedYear.getKey();

        List<Employee> empHours = getEmployeeHours(monthValue, yearValue, employeeSearchID);
        validatePayrollData(empHours, monthValue, yearValue);
    ...
    private void handlePayrollDropdownChange() {
        if (monthDropdown.getSelectedItem() != null && yearDropdown.getSelectedItem() != null) {
            ...
            if (monthValue != null && year != null && empId != null) {
